 ...
 */
final class Version20260323093400 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add missing max_score, taken_at, created_at columns to quiz_result table';
    }

    public function up(Schema $schema): void
    {
        // Add columns as nullable first
        $this->addSql('ALTER TABLE quiz_result ADD max_score INT DEFAULT 100');
        ...
        $this->addSql('UPDATE quiz_result SET max_score = 100 WHERE max_score IS NULL');
        ...
        $this->addSql('ALTER TABLE quiz_result MODIFY max_score INT NOT NULL');
    ...
    {
        $this->addSql('ALTER TABLE quiz_result DROP max_score');
