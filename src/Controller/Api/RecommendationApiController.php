...
class RecommendationApiController extends AbstractController
{
    ...
    public function getRecentlyViewed(Request $request, SessionInterface $session): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                ...
                'data' => $recentlyViewed,
                'meta' => [
                    'type' => $userId !== null && $userId !== '' ? 'user_based' : 'session_based',
    ...
    public function getRecommendedProducts(Request $request, SessionInterface $session): JsonResponse
    {
        try {
            ...
            return new JsonResponse([
                ...
                'data' => $recommended,
                'meta' => [
                    'type' => $userId !== null && $userId !== '' ? 'personalized' : 'session_based',
                    'count' => count($recommended),
                    'limit' => $limit,
                    'algorithm' => $userId !== null && $userId !== '' ? 'collaborative_filtering' : 'popular_in_category'
                ]
            ]);
        } catch (\Exception $e) {
            return new JsonResponse([
    ...
    private function getUserRecentlyViewed(\App\Entity\User $user, int $limit): array
    {
    ...
    private function getPersonalizedRecommendations(\App\Entity\User $user, int $limit): array
    {
    ...
    private function getAlsoBoughtProductsPrivate(\App\Entity\Product $product, int $limit): array
    {
