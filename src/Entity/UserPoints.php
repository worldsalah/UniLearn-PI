...
class UserPoints
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'userPointsList')]
    ...
    public function getProgressToNextLevel(): float
    {
        ...
        $levelMin = $this->currentLevel->getMinXp() ?? 0;
        $levelMax = $this->currentLevel->getMaxXp() ?? 0;
        ...
        $progressInLevel = $this->currentLevelPoints - $levelMin;
    ...
    public function getPointsToNextLevel(): int
    {
        ...
        $levelMax = $this->currentLevel->getMaxXp() ?? 0;
        return max(0, $levelMax - $this->currentLevelPoints);
    }

    public function __toString(): string
    {
        return $this->user !== null ? $this->user->getFullName() . ' - ' . $this->totalPoints . ' XP' : '';
    }
}
