 ...
 */
class getCheckoutRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CheckoutRepository' shared autowired service.
     *
     * @return \App\Repository\CheckoutRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CheckoutRepository.php';

        return $container->privates['App\\Repository\\CheckoutRepository'] = new \App\Repository\CheckoutRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
