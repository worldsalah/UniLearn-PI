 ...
 */
class getCourseCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CourseCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\CourseCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CourseCategoryRepository.php';

        return $container->privates['App\\Repository\\CourseCategoryRepository'] = new \App\Repository\CourseCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
