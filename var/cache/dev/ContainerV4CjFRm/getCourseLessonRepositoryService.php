 ...
 */
class getCourseLessonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CourseLessonRepository' shared autowired service.
     *
     * @return \App\Repository\CourseLessonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CourseLessonRepository.php';

        return $container->privates['App\\Repository\\CourseLessonRepository'] = new \App\Repository\CourseLessonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
