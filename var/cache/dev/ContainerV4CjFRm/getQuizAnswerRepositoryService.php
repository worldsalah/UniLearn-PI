 ...
 */
class getQuizAnswerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuizAnswerRepository' shared autowired service.
     *
     * @return \App\Repository\QuizAnswerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizAnswerRepository.php';

        return $container->privates['App\\Repository\\QuizAnswerRepository'] = new \App\Repository\QuizAnswerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
