 ...
 */
class getQuizSettingsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuizSettingsRepository' shared autowired service.
     *
     * @return \App\Repository\QuizSettingsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizSettingsRepository.php';

        return $container->privates['App\\Repository\\QuizSettingsRepository'] = new \App\Repository\QuizSettingsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
