...
class getVichUploader_Listener_Clean_AvatarsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('avatars', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.clean.avatars'])) {
            return $container->privates['vich_uploader.listener.clean.avatars'];
        }

        return $container->privates['vich_uploader.listener.clean.avatars'] = $instance;
    }
}
