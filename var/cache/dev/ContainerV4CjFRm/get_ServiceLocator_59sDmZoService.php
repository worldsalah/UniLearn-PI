...
class get_ServiceLocator_59sDmZoService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.59sDmZo'])) {
            return $container->privates['.service_locator.59sDmZo'];
        }

        return $container->privates['.service_locator.59sDmZo'] = $instance;
    }
}
